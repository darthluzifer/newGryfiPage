...
class PhonenumberAddress extends \Concrete\Package\BaclucPersonPackage\Src\PhonenumberAddress implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'phonenumber', 'type', 'organisation', 'info', 'protect', 'protectRead', 'protectWrite', 'fieldTypes', 'em', 'defaultFormView', 'defaultSubFormView', 'checkingConsistency'];
        }
