...
class DropdownBlockOption extends \Concrete\Package\BasicTablePackage\Src\BlockOptions\DropdownBlockOption implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'possibleValues', 'id', 'optionType', 'optionValue', 'BasicTableInstance', 'optionName', 'protect', 'protectRead', 'protectWrite', 'fieldTypes', 'em', 'defaultFormView', 'defaultSubFormView', 'checkingConsistency'];
        }
