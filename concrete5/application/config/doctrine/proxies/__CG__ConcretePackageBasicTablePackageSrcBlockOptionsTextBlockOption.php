 ...
 */
class TextBlockOption extends \Concrete\Package\BasicTablePackage\Src\BlockOptions\TextBlockOption implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextBlockOption $proxy) {
