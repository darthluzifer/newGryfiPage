...
class Person extends \Concrete\Package\BaclucPersonPackage\Src\Person implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'scoutname', 'surname', 'middlename', 'lastname', 'birthdate', 'public_picture_allowed', 'Parents', 'Children', 'PostalAddresses', 'PhonenumberAddresses', 'EmailAddresses', 'Addresses', 'protect', 'protectRead', 'protectWrite', 'fieldTypes', 'em', 'defaultFormView', 'defaultSubFormView', 'checkingConsistency');
        }
