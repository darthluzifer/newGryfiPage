...
class GroupRefOptionGroup extends \Concrete\Package\BasicTablePackage\Src\BlockOptions\GroupRefOptionGroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'GroupRefOption', 'Group', 'protect', 'protectRead', 'protectWrite', 'fieldTypes', 'em', 'defaultFormView', 'defaultSubFormView', 'checkingConsistency');
        }
