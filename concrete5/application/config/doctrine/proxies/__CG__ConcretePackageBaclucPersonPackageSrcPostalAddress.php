...
class PostalAddress extends \Concrete\Package\BaclucPersonPackage\Src\PostalAddress implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'address', 'additionalinfo', 'floor', 'postalcode', 'city', 'state', 'country', 'type', 'organisation', 'info', 'protect', 'protectRead', 'protectWrite', 'fieldTypes', 'em', 'defaultFormView', 'defaultSubFormView', 'checkingConsistency'];
        }
