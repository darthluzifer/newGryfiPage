...
<div class="bacluc_event bacluc_event_next_event_block">
	<div class="row">
		...
		<div class="col-xs-12 daterow">
			<div class="row">
				<div class="col-xs-12 col-sm-6"><?php echo " <span class='prefix from_prefix'>".t("Von:")."</span> ".$date_from." ".$time_from;  ?></div>
				<div class="col-xs-12 col-sm-6"><?php echo " <span class='prefix to_prefix'>".t("Bis:")."</span> ".$date_to." ".$time_to;  ?></div>
			</div>
		</div>
		<div class="col-xs-12 description"><?php echo $description ?></div>
		<?php if(strlen($registerfile)>0){?>
			<div class="col-xs-12 filelink register"><?php  echo " <span class='prefix register_prefix'>".t("Anmeldung:")."</span> ".$registerfile ?></div>
		<?php }?>
		<?php if(strlen($infofile)>0){?>
			<div class="col-xs-12 filelink info"><?php  echo " <span class='prefix info_prefix'>".t("Informationen:")."</span> ".$infofile ?></div>
		<?php }?>
	</div>
